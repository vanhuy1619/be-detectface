...
public class User {
    ...
    @Exclude
    public ArrayList<DataItem> getFavouriteFishItem() {
        ArrayList<DataItem> favFish = new ArrayList<>();
        for (DataItem fish : DataItem.allFishes) {
    ...
    @Exclude
    public ArrayList<DataItem> getViewedFishItems() {
        ArrayList<DataItem> viewedFish = new ArrayList<>();
        for (DataItem fish : DataItem.allFishes) {
